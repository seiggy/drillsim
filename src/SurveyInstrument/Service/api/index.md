---
title: "Project: Microservice for SurveyInstrument"
output: html_document
---

Objective
===
This project contains the microservice that allows to access the management of SurveyInstrument.


Principles
===
The microservice provides a web API and is containerized using Docker. The web api endpoint is `SurveyInstrument/api/`. It is possible to upload new data 
