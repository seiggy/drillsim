...
internal abstract class GeodeticDatumToolBase : IMcpTool
{
    private readonly IServiceScopeFactory _scopeFactory;

    protected GeodeticDatumToolBase(IServiceScopeFactory scopeFactory)
    {
    ...
    protected ControllerAccessor CreateControllerScope()
    {
        ...
        var controller = scope.ServiceProvider.GetRequiredService<GeodeticDatumController>();
    ...
    protected readonly struct ControllerAccessor : IDisposable
    {
        ...
        public ControllerAccessor(IServiceScope scope, GeodeticDatumController controller)
        {
            _scope = scope;
            Controller = controller;
        }

        public GeodeticDatumController Controller { get; }
