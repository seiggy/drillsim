...
class Program
{
    ...
    private static readonly string JSON_BUNDLE = "GeodeticDatumMergedModel.json";
    private static readonly string CSHARP_MODEL = "GeodeticDatumMergedModel.cs";
    
    // ### BEGIN CODE SPECIFIC TO ModelSharedOut 3/3 ###
    private static readonly string NAMESPACE = "NORCE.Drilling.GeodeticDatum.ModelShared"; // should be the same as for ModelSharedIn to avoid type name collision
