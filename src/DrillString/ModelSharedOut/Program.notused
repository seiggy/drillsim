...
class Program
{
    ...
    private static readonly string MODELSHARED_FOLDER = Path.DirectorySeparatorChar + "ModelSharedOut";
    private static readonly string JSON_OUTPUT_FOLDER = Path.DirectorySeparatorChar + "Service" + Path.DirectorySeparatorChar + "wwwroot" + Path.DirectorySeparatorChar + "json-schema";
