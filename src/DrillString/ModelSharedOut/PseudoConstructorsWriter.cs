...
namespace NORCE.Drilling.DrillString.PseudoConstructorsWriter
    {
    class Writer
    {     
        private static readonly string NAMESPACE = "NORCE.Drilling.DrillString.ModelShared";    
        ...
        public static bool ChangeICollectionToList(DirectoryInfo directory)
        {
            ...
            {                
                ...
                string filePath = fullPath + "DrillStringMergedModel.cs";
