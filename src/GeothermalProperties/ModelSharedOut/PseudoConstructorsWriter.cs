...
namespace NORCE.Drilling.GeothermalProperties.PseudoConstructorsWriter
    {
    class Writer
    {     
        private static readonly string NAMESPACE = "NORCE.Drilling.GeothermalProperties.ModelShared";    
        ...
        public static bool ChangeICollectionToList(DirectoryInfo directory)
        {
            ...
            {                
                ...
                string filePath = fullPath + "GeothermalPropertiesMergedModel.cs";
