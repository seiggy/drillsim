...
The GeothermalProperties repository hosts a microservice and client webapp for GeothermalProperties.
...
- **ModelSharedOut**
  ...
  - *dependencies* = GeothermalProperties.json + some external microservices (OpenApi schemas in json format)
- **ModelTest**
...
- **WebApp**
  - microservice web app client that manages data associated with GeothermalProperties and allow to interact with the microservice
  - *dependencies* = ModelShared
- **home** (auto-generated)
  - data are persisted in the microservice container using the Sqlite database located at *home/GeothermalProperties.db*
...
https://dev.digiwells.no/GeothermalProperties/api/GeothermalPropertiesCompletionOrder

https://app.digiwells.no/GeothermalProperties/api/GeothermalPropertiesCompletionOrder

Web app is available at:

https://dev.digiwells.no/GeothermalProperties/webapp/GeothermalPropertiesCompletionOrder

https://app.digiwells.no/GeothermalProperties/webapp/GeothermalPropertiesCompletionOrder

The OpenApi schema of the microservice is available and testable at:

https://dev.digiwells.no/GeothermalProperties/swagger (development server) 

https://app.digiwells.no/GeothermalProperties/swagger (production server)
