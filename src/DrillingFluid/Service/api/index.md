---
title: "Project: Microservice for DrillingFluid"
output: html_document
---

Objective
===
This project contains the microservice that allows to access the management of DrillingFluid.


Principles
===
The microservice provides a web API and is containerized using Docker. The web api endpoint is `DrillingFluid/api/`. It is possible to upload new data 
