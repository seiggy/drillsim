...
using NORCE.Drilling.DrillingFluid.Service;
...
builder.Services.AddOpenApi("v1", options =>
{
    ...
    {
        document.Servers = [new OpenApiServer { Url = "/drillingfluid/api" }];
...
var basePath = "/drillingfluid/api";
var scheme = "http";
...
var mergedDoc = SwaggerMiddlewareExtensions.ReadOpenApiDocument("wwwroot/json-schema/DrillingFluidMergedModel.json");
