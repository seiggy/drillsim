...
namespace NORCE.Drilling.DrillingFluid.PseudoConstructorsWriter
    {
    class Writer
    {     
        private static readonly string NAMESPACE = "NORCE.Drilling.DrillingFluid.ModelShared";    
        ...
        public static bool ChangeICollectionToList(DirectoryInfo directory)
        {
            ...
            {                
                ...
                string filePath = fullPath + "DrillingFluidMergedModel.cs";
