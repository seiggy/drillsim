...
builder.Services.AddOpenApi("v1", options =>
{
    ...
    {
        document.Servers = [new OpenApiServer { Url = "/well/api" }];
...
builder.Services.AddWellRestMcpTools();

// end MCP server

var app = builder.Build();

var basePath = "/well/api";
var scheme = "http";
...
var mergedDoc = SwaggerMiddlewareExtensions.ReadOpenApiDocument("wwwroot/json-schema/WellMergedModel.json");
