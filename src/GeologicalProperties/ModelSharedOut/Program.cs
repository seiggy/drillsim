...
class Program
{
    ...
    private static readonly string JSON_BUNDLE = "GeologicalPropertiesMergedModel.json";
    private static readonly string CSHARP_MODEL = "GeologicalPropertiesMergedModel.cs";
    
    // ### BEGIN CODE SPECIFIC TO ModelSharedOut 3/3 ###
    private static readonly string NAMESPACE = "GeologicalPropertiesApp.GeologicalProperties.ModelShared"; // should be the same as for ModelSharedIn to avoid type name collision
