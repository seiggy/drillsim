...
namespace YPLCalibrationFromRheometer.Service
{
    public class SQLConnectionManager
    {
        ...
        public static void Initialize(ILoggerFactory loggerFactory, string? databasePath = null)
        {
            if (logger_ == null)
            ...
            {
                string connectionString = $"Data Source={databasePath ?? Path.Combine(homeDirectory, "YPLCalibrationFromRheometer.db")}";
