...
class Program
{
    ...
    private static readonly string JSON_BUNDLE = "WellBoreMergedModel.json";
    private static readonly string CSHARP_MODEL = "WellBoreMergedModel.cs";
    
    // ### BEGIN CODE SPECIFIC TO ModelSharedOut 3/3 ###
    private static readonly string NAMESPACE = "NORCE.Drilling.WellBore.ModelShared"; // should be the same as for ModelSharedIn to avoid type name collision
