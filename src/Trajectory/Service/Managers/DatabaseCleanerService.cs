...
namespace NORCE.Drilling.Trajectory.Service.Managers
{
    public class DatabaseCleanerService : BackgroundService
    {
        ...
        private readonly string[] _dataTables = ["InterpolatedTrajectoryTable", "SurveyStationEllipseCalculationTable", "TrajectoryMinimumDistanceCalculationTable", "SurveyRunMinimumDistanceCalculationTable", "TrajectoryAggregationCaseTable"];
