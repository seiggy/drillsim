---
title: "Project: Microservice for Trajectory"
output: html_document
---

Objective
===
This project contains the microservice that allows to access the management of Trajectory.


Principles
===
The microservice provides a web API and is containerized using Docker. The web api endpoint is `Trajectory/api/`. It is possible to upload new data 
