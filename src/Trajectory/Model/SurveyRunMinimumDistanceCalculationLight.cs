...
{
    public class SurveyRunMinimumDistanceCalculationLight
    {
        ...
        public Guid ReferenceSurveyRunID { get; set; }
        public List<Guid>? ComparisonSurveyRunIDList { get; set; }
        ...
        public SurveyRunMinimumDistanceCalculationLight()
        {
        }
    }
}
